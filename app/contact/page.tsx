      ...
      <main className="min-h-screen bg-background overflow-x-hidden">
        ...
        <section className="pt-10 pb-2">
          <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-24 max-w-5xl">
            <p className="text-[15px] text-slate-600 leading-relaxed font-subtext text-center max-w-2xl mx-auto">
          ...
          <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-24 max-w-5xl">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center sm:text-left">
              ...
              <div className="flex flex-col items-center sm:items-start gap-2">
                ...
                <a href="tel:+917316056001" className="text-sm text-foreground hover:text-[#0e7c6e] transition-colors">0731-6056001</a>
                <a href="tel:+919300001411" className="text-sm text-foreground hover:text-[#0e7c6e] transition-colors">+91 93000 01411</a>
              </div>
